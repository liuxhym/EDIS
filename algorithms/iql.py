...
class TrainConfig(object):
    def __init__(self, beta=10.0, iql_tau=0.7, \
    tau=0.005, normalize=True, normalize_reward=False):
        # Experiment
        self.device: str = "cuda"
        self.env: str = "halfcheetah-random-v2"  # OpenAI gym environment name
        ...
        self.load_model: str = "offline_model.pth"  # Model load file name, "" doesn't load
        # IQL
        ...
        self.log_name: str = "IQL_baseline"
...
def train(args):
    ...
    if 'hopper' in env_name or 'halfcheetah' in env_name or 'walker2d' in env_name:
        ...
        gin_config_files = 'configs/iql/' + env_name + '/' + other_name + '.gin'
    ...
    if config.load_model != "":
        policy_file = "logs/IQL/{}/{}".format(config.env, config.load_model)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--env", type=str, default="halfcheetah-random-v2") ################ task
